# EML PraatGen v1.0.1 Release Notes

**1.0.1** (stable release; leaves the 0.9.x beta line)  
...
**Phase 3B is model-conditional.** Extended thinking as a user-facing toggle was retired in Opus 4.8. The complexity score is unchanged; on toggle models (4.6/4.7) it recommends thinking on/off and waits on a recommended change, and on effort models (4.8+) it is advisory and does not gate the turn.
...
1.0.0 shipped on 29 July and is superseded by this build; if you took it, the
changes are the 14.7.2 and 14.8.x sections above.

---

## Upgrade notes

Replace your project's instructions with `MASTER_PROMPT_CORE_v14_8_1.md`. The filename changed; delete `MASTER_PROMPT_CORE_v13_9_4.md`.

...
2. Paste the entire contents of `MASTER_PROMPT_CORE_v14_12_0.md` into the instructions field
...
| File | Purpose |
|------|---------|
| `MASTER_PROMPT_CORE_v14_12_0.md` | The system instructions that configure Claude as a Praat scripting specialist. Contains 37 rules governing syntax validation, command verification, clinical defaults, debugging protocol, sandbox/autonomous modes, and code-quality standards. Master Prompt content version: 14.12.0. |
| `README.md` | This file. |
...
| **Master Prompt** | 14.12.0 | The system instructions. Bumped when rules, workflow, or protocols change. |

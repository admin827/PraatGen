...
2. Paste the entire contents of `MASTER_PROMPT_CORE_v14_8_0.md` into the instructions field
...
| File | Purpose |
|------|---------|
| `MASTER_PROMPT_CORE_v14_8_0.md` | The system instructions that configure Claude as a Praat scripting specialist. Contains 37 rules governing syntax validation, command verification, clinical defaults, debugging protocol, sandbox/autonomous modes, and code-quality standards. Master Prompt content version: 14.8.0. |
| `README.md` | This file. |
...
| **Master Prompt** | 14.8.0 | The system instructions. Bumped when rules, workflow, or protocols change. |
...
- **1.0.0 (29 July 2026)** is the first stable release, leaving the 0.9.x beta track. It ships Master Prompt 14.8.0. The PKB is reconciled against the EML plugin source, the procedure registry is generated from that source, and every library file is syntax-checked against Praat 6.6.30.

...
**Current: 14.18.0.** The sandbox Praat version is pinned to 6.6.30 while
Praat 7's trust behaviour settles. The floor stays at 6.4.39, measured rather than
assumed, and the version check reports a per-command list — what this script
uses, what the running Praat does with it, and whether that means a stop or a
different number. No generic "your Praat is old" notice.
